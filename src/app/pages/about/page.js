        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              At ShreeHarivatika, we believe that everyone deserves a seamless
              and stress-free experience when planning their travels. Our
              platform is designed to provide you with access to a wide variety
              of accommodations, from luxurious resorts to cozy boutique stays.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
